...
public class IntegrationTestMessEngine {
  ...
  public void shouldListenFooMessage() throws Exception {
    ...
    engine.start();
    MessageListener<String> listener = (Message<String> message) -> {
  ...
  public void shouldHaveManyListenersForTheSameMessageType() throws Exception {
    ...
    engine.start();
    final AtomicInteger counter = new AtomicInteger();
    final MessageListener<String> listenerA = new MessageListener<String>() {
      @Override
      public void onMessage(Message<String> message) {
        counter.incrementAndGet();
        lock.release();
    ...
    final MessageListener<String> listenerB = new MessageListener<String>() {
      @Override
      public void onMessage(Message<String> message) {
        counter.incrementAndGet();
        lock.release();
