...
public class StubMessEngine implements MessEngine {
	...
	private MessEngineConfigurator configurator = new MessEngineConfigurator(this);

	public void setup(Object object) {
		configurator.setupMessEngine(object);
	}

	public void reset(Object object) {
		configurator.resetMessEngine(object);
	}
